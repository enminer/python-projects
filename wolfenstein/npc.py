...
class CacoDemonNPC(NPC):
    def __init__(self, game, path='recources/sprites/npc/caco_demon/0.png', pos=(10.5, 6.5),
...
class CyberDemonNPC(NPC):
    def __init__(self, game, path='recources/sprites/npc/cyber_demon/0.png', pos=(11.5, 6.0),
